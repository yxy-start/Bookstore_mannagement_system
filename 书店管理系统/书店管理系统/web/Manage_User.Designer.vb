...
Partial Class Manage_User
    ...
    Private Sub InitializeComponent()
        ...
        Me.系统用户表BindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.BookstoreDataSet = New 书店管理系统.BookstoreDataSet()
        Me.系统用户表TableAdapter = New 书店管理系统.BookstoreDataSetTableAdapters.系统用户表TableAdapter()
        Me.GroupBox1.SuspendLayout()
        Me.GroupBox2.SuspendLayout()
        CType(Me.DataGridView1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.系统用户表BindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.Label5.Location = New System.Drawing.Point(50, 369)
        ...
        Me.DataGridView1.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.用户名DataGridViewTextBoxColumn, Me.性别DataGridViewTextBoxColumn, Me.电话DataGridViewTextBoxColumn})
        Me.DataGridView1.DataSource = Me.系统用户表BindingSource
        ...
        '系统用户表BindingSource
        '
        Me.系统用户表BindingSource.DataMember = "系统用户表"
        Me.系统用户表BindingSource.DataSource = Me.BookstoreDataSet
        '
        'BookstoreDataSet
        '
        ...
        '系统用户表TableAdapter
        '
        Me.系统用户表TableAdapter.ClearBeforeFill = True
        '
        'Manage_User
        '
        ...
        CType(Me.系统用户表BindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents BookstoreDataSet As 书店管理系统.BookstoreDataSet
    Friend WithEvents 系统用户表BindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents 系统用户表TableAdapter As 书店管理系统.BookstoreDataSetTableAdapters.系统用户表TableAdapter
    ...
    Friend WithEvents 电话DataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
End Class
